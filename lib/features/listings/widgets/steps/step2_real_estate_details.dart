      ...
      child: Directionality(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('نوع العرض *', style: theme.textTheme.titleSmall),
            ...
            const SizedBox(height: 8),
            Text('عدد الغرف', style: theme.textTheme.titleSmall),
            const SizedBox(height: 8),
            Step2ChipSelector(
            ...
            const SizedBox(height: 12),
            Text('عدد الحمامات', style: theme.textTheme.titleSmall),
            const SizedBox(height: 8),
            Step2ChipSelector(
            ...
            const SizedBox(height: 8),
            Text('المميزات', style: theme.textTheme.titleSmall),
            const SizedBox(height: 8),
